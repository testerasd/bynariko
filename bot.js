const Discord = require('discord.js');  //Nariko#2009
const client = new Discord.Client();  //Nariko#2009
const moment = require('moment'); //Nariko#2009
const zalgo = require('zalgolize');  //Nariko#2009
const math = require('math-expression-evaluator');    //Nariko#2009
const figlet = require('figlet');   //Nariko#2009
const fs = require('fs');  //Nariko#2009
const ms = require('ms');  //Nariko#2009
const prefix = '-'

client.on('message', msg => {  //Nariko#2009
    if (msg.content === 'باك') {  //Nariko#2009
      msg.reply('** :wink: وِلِـكُمِـ ﻧَوِرُتْ   :sparkling_heart:**'); //Nariko#2009
    }
  });

client.on('message', msg => {  //Nariko#2009
    if (msg.content === 'ويسو') {  //Nariko#2009
      msg.reply('**ويسو مات**');  //Nariko#2009
    }
  });


client.on('message', msg => {  //Nariko#2009
    if (msg.content === 'احبك') {  //Nariko#2009
      msg.reply('**لاتحتك يا اخوي لو سمحت**');  //Nariko#2009
    }
  });
  ...
  client.on('message', msg => { //Nariko#2009
    if (msg.content === 'احبك') {  //Nariko#2009
      msg.reply('**حبك برص يا سافل**');  //Nariko#2009
    }
  });
   ...
   client.on('message', msg => {  //Nariko#2009
    if (msg.content === 'هلا') {  //Nariko#2009
      msg.reply('**هلا بيك :heart: **');  //Nariko#2009
    }
  });
